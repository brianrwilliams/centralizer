...
\[
\tilde{f}: \Omega^*_c(V) \otimes \fg \to \Omega^*_c(V) \otimes \fh
\]
...
This action extends immediately to the module $(\Omega^*_c(V) \otimes \fh)_f$, so we now view it as an $L_\infty$ module over $\Omega^*(V)$ as well.
In consequence, we have a cochain complex
\[
\clies(\Omega^*(V) \otimes \fg, (\Omega^*_c(V) \otimes \fh)_f)
\]
on each open set~$V$.
...
In consequence, the action of $\Omega^*(V) \otimes \fg$ on $(\Omega^*_c(V') \otimes \fh)_f$ arising from the restriction map $\Omega^*(V) \otimes \fg \to \Omega^*(V') \otimes \fg$ of $L_\infty$ algebras agrees with action induced by the inclusion of $(\Omega^*_c(V') \otimes \fh)_f$ as a (strict) submodule of~$(\Omega^*_c(V) \otimes \fh)_f$.
This argument is manifestly associative under composition of inclusions, so we have shown our first claim.

\begin{lmm}
The assignment
\[
V \mapsto \clies(\Omega^*(V) \otimes \fg, (\Omega^*_c(V) \otimes \fh)_f)
\]
...
\[
\clies(\Omega^*(D) \otimes \fg, (\Omega^*_c(D) \otimes \fh)_f) \xto{\simeq} \clies(\Omega^*(D) \otimes \fg, (\Omega^*_c(D) \otimes \fh)_f)
\]
a quasi-isomorphism.
