...
\owen{Point out how to use LQT map and deduce existence of $\EE_n$ algebra structure on a shifted copy of cyclic cohomology of~$\Omega^\bu_c$. Also do the Loday versions that use the other infinite series.}
