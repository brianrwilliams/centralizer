...
\begin{rmk}
Here, we remark that pulling back along an embedding $\iota : U \hookrightarrow V \times [0,\epsilon)$, where $U \subset M \times \RR_{>0}$ determines a composition of cochain complexes
\[
