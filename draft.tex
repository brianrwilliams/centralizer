...
\[
\Theta_{\bf{f}}: \clies(\Omega^* \otimes \fg, (\Omega^*_c \otimes \fh)_f) \otimes \bU_n \fg \to \bU_n \fh,
\]
...
\[
\Theta_{\bf{f}}(V): \clies(\Omega^*(V) \otimes \fg, (\Omega^*_c(V) \otimes \fh)_f) \otimes \bU_n \fg(V) \to \bU_n \fh(V)
\]
for each open~$V$.
...
\begin{lmm}
\label{L:pairingCE}
The natural transformation $\Theta_{\bf{f}}$ determines a map of strict prefactorization algebras,
