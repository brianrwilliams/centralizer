...
\brian{Review interpretation of the center as a swiss cheese algebra context of Deligne conjecture}

\begin{prp}
For any smooth manifold $M$ and Lie algebra $\fg$ the pair $(\bZ_n(\fg), \bU_n (\fg))$ define a constructible factorization algebra on the $(n+1)$-manifold with boundary $M \times [0,1)$.
\end{prp}
