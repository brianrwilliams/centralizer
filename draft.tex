...
\[
\bC_n(\fg)^{\circ} (V) = \clies \bigg(\fg \otimes \Omega (V \times \RR_{>0} ) \; , \; \Sym \left(\fg \otimes \Omega_c(V \times \RR_{>0}) [2] \right) \bigg)  .
\]
...
Next, using the map $r_\phi$, wedefine a map of factorization algebras
\[
